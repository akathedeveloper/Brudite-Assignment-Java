public class Main {
    ...
    Students s2=new Students("Kanishk Tiwari",102,"kanishktiwari@gmail.com",98313941);
    Students s3=new Students("Paras Goyal",101,"adhirajsingh@gmail.com",98313941);
    Students s4=new Students("Varun Pareek",101,"adhirajsingh@gmail.com",98313941);
